...
# -----------------------------
# LOAD JEKYLL CONFIG VARIABLES
# -----------------------------
chmod +x _build/sh/jekyll_config_loader.sh
# (Use the 'source' command (or the '.' shorthand) - to load the functions
. ./_build/sh/jekyll_config_loader.sh
